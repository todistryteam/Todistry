...
import Header from "../src/components/dsca/Header";
import HowITWorks from "../src/components/dsca/HowITWorks";
import CustomersReviews from "../src/components/CustomersReviews";
import CTA from "@/src/components/CTA";

import { getDSCAPageHeader, getClientsReview } from "./api";
...
const DSCA = () => {
  ...
  const getPageData = async () => {
      try {
          const res = await getDSCAPageHeader();
          if (res?.data) {
